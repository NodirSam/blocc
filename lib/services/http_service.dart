...
class Network {
  static String BASE = "6421a05d34d6cd4ebd781823.mockapi.io";
  static Map<String,String> headers = {'Content-Type':'application/json; charset=UTF-8'};

  /* Http Apis */

  static String API_LIST = "/api/contact";
  static String API_CREATE = "/api/contact";
  static String API_UPDATE = "/api/contact/"; //{id}
